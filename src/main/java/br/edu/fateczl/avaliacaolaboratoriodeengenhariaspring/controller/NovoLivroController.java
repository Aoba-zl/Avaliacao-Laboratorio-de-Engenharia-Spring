...
public class NovoLivroController {
    ...
    public ModelAndView doPost(@RequestParam Map<String, String> allRequestParam, ModelMap model) {
        ...
        try {
            if (Objects.equals(codigo, "") || Objects.equals(titulo, "") || Objects.equals(descricao, "") || Objects.equals(genero, "") || Objects.equals(autor, "") ||
                ...
                atualizarCampos(codigo, titulo, descricao, genero, autor, preco, dt_publicacao, num_paginas, estoque);
            }
            else {
    ...
    private void atualizarCampos(String codigo, String titulo, String descricao, String genero, String autor,
                                 String preco, String dt_publicacao, String num_paginas, String estoque) {
        if (!Objects.equals(codigo, "")) {
            l.setCodigo(Integer.parseInt(codigo));
        }
